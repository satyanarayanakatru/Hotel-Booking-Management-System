    ...
    <div className="max-w-2xl mx-auto py-6">
      <div className="bg-white rounded-2xl shadow-xl border border-slate-200/80 overflow-hidden">
        ...
        <div className="bg-slate-900 p-6 text-white flex items-center space-x-4">
          <div className="h-16 w-16 rounded-full bg-blue-600 border-2 border-blue-400 flex items-center justify-center font-bold text-2xl">
            {user?.fullName ? user.fullName.charAt(0).toUpperCase() : 'U'}
          </div>
          <div>
            <h1 className="text-xl font-bold">{user?.fullName}</h1>
            <p className="text-xs text-slate-400">{user?.email}</p>
            <div className="mt-2 inline-flex items-center space-x-1 px-2.5 py-0.5 bg-blue-500/20 text-blue-300 rounded-md text-xs font-medium border border-blue-400/20">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
          ...
          <div className="flex justify-end pt-2">
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 px-6 rounded-lg text-sm transition-all shadow-md flex items-center space-x-2"
            >
